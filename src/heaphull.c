 ...
 * max-heap.  
 */
static void heapify(point_t *s, int n, int i, int dir)
{
  int min;
  bool done;
  point_t tmp;
 ...
 */
static void build_heap(point_t *s, int n, int dir)
{
  int i;
 ...
 */
static int partition(point_t *s, int n)
{
  int i, l = 0, r = 0;
  point_t a, b, tmp;
 ...
 */
static int heap_compute_hull(point_t *s, int n, int tos, int h, int dir)
{
  point_t tmp;
